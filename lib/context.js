...
var Context = function (conn, loggerOptions = {}) {
...
Context.prototype.waitReady = function () {
  return new Promise((resolve, reject) => {
    if (this.state === state.waiting) return resolve();
    this.internalEmitter.on('ready', resolve);
  });
}
